...
const Header: NextComponentType = () => {
  return (
    ...
    >
      ...
      <Link href="https://github.com/dehviana" passHref>
        <a
          className="float-right hidden mr-2 rounded-lg bg-zinc-800 p-2 text-2xl text-white ring-zinc-300 transition-all duration-150 hover:ring-2 sm:float-none sm:mr-0"
          target="_blank"
